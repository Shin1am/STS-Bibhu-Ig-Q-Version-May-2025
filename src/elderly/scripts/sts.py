...
class STSRobot:
    ...
    def initialize_communication(self):
        ...
        if n_found_devices == 5:
            ...
            self.speak("All motor controllers connected successfully")

        elif n_found_devices < 5:
            rospy.logwarn(f"Not found {5 - n_found_devices} devices.")
            self.speak(f"Warning: {5 - n_found_devices} motor controllers not found")
    ...
    def run(self):
        ...
        # intialization
        self.speak("S T S Robot initializing")
